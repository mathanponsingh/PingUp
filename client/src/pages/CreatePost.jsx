      ...
      <div className='max-w-6xl mx-auto p-6'>
        ...
        space-y-4'>
          ...
          <div className='flex items-center gap-3'>
            <img src={user.profile_picture} alt="" className='rounded-full w-12 h-12 shadow'/>
            <div>
          ...
          outline-none placeholder-gray-400' placeholder="What's happening?"onChange={(e)=>setContent(e.target.value)} value={content}/>
          {/* Images */}
          {
            images.length > 0 && 
            <div className='flex flex-wrap gap-2 mt-4'>
              {
                images.map((image,i)=>(
                  <div key={i} className='relative group'>
                    ...
                    items-center inset-0 bg-black/40
          ...
          border-gray-300'>
            <label htmlFor="images" className='flex items-center text-sm
