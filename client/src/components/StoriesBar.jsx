      ...
      <div className="flex gap-4 pb-5">
        ...
        <div
          ...
          className="rounded-lg shadow-sm min-w-30 max-w-30 max-h-40 aspect-[3/4]
            cursor-pointer border border-dashed border-indigo-300 bg-gradient-to-b from-indigo-50 to-white"
        >
          <div
        ...
        {stories.map((story, index) => (
          ...
          >
            ...
            <p
              className="absolute text-white bottom-1 right-2 z-10
                        text-xs"
            >
                ...
                {story.media_type === "image" ? (
                  <img
                    ...
                    className="h-full w-full
                            object-cover hover:scale-110 transition duration-500 opacity-70
                            hover:opacity-80"
                  />
                ) : (
                  <video
