          ...
          <form className="space-y-4" onSubmit={(e)=>toast.promise(
                ...
                <div className="group/profile relative">
                  ...
                  <div
                    className="absolute hidden group-hover/profile:flex
                                top-0 right-0 bottom-0 left-0 bg-black/20
              ...
              >
                ...
                <div className="relative group/cover">
                  <img
                    ...
                    alt=""
                    className="w-80 h-40  bg-gradient-to-r
                    from-indigo-200 via-purple-200 to-pink-200 object-cover
                    mt-2 rounded-lg"
                  />
                  <div className="absolute hidden group-hover/cover:flex top-0 right-0 left-0 bottom-0 items-center rounded-lg justify-center bg-black/20 cursor-pointer">
                    <Pencil className="w-5 h-5 text-white" />
                  </div>
                </div>
              </label>
            ...
            <div className="flex justify-end space-x-3 pt-6">
              ...
              <button
                ...
                hover:to-purple-700 transition cursor-pointer active:scale-95"
              >
                Save Changes
              </button>
            </div>
